...
public class NuevaReservaDTO {
    ...
    public NuevaReservaDTO(int id, int numeroAula, Tiempo horaInicio, Tiempo horaFin,
    ...
    public NuevaReservaDTO(int numeroAula, Tiempo horaInicio, Tiempo horaFin,
    ...
    public NuevaReservaDTO fromResultSet(ResultSet resultSet) throws SQLException {
        ...
        return new NuevaReservaDTO(id, numeroAula, horaInicio, horaFin, fechaHoraReserva, fechaActividad, descripcion, responsable);
    }
