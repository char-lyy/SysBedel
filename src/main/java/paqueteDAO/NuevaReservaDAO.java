...
public class NuevaReservaDAO {

    private Connection connection;

    public NuevaReservaDAO(Connection connection) {
        this.connection = connection;
    }

    // Método para insertar una nueva reserva
    public boolean insertarReserva(NuevaReservaDTO nuevaReserva) {
    ...
    public NuevaReservaDTO buscarReservaPorId(int id) {
    ...
    public List<NuevaReservaDTO> obtenerReservas() {
        List<NuevaReservaDTO> reservas = new ArrayList<>();
    ...
    public boolean actualizarReserva(NuevaReservaDTO nuevaReserva) {
    ...
    private NuevaReservaDTO mapResultSetToReservaDTO(ResultSet resultSet) throws SQLException {
        NuevaReservaDTO nuevaReservaDTO = new NuevaReservaDTO();
